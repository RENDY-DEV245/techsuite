...
import { Layers, Globe, Smartphone, Server, Terminal, Lock, Box, Database } from 'lucide-react';

export type FlowDomainId = 'all' | 'web' | 'mobile' | 'backend' | 'erp' | 'cad' | 'devops' | 'cybersecurity';
